...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization'); // allowing for the request to have content type header and authorization header on requests
  next();
});
